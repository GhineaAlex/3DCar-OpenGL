...
World::World() {
	...
	//ground->SetColor(new Vector3D(1,1,1));
	//ground->SetColor(new Vector3D(0, 0, 0));

	map = new Map();
	//char a[] = {"data\\skybox\\left.bmp" };

	LoadBmpTexture((char*)"data/skybox/back.bmp", &skybox[0]);
	LoadBmpTexture((char*)"data/skybox/front.bmp", &skybox[1]);
	LoadBmpTexture((char*)"data/skybox/right.bmp", &skybox[2]);
	LoadBmpTexture((char*)"data/skybox/back.bmp", &skybox[3]);
	LoadBmpTexture((char*)"data/skybox/down.bmp", &skybox[4]);
	LoadBmpTexture((char*)"data/skybox/up.bmp", &skybox[5]);
